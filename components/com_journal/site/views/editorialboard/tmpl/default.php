...
$content = array(
 'ru' => file_get_contents("{$this->folder_local}/editorialboard_ru.htm"),
 'en' => file_get_contents("{$this->folder_local}/editorialboard_en.htm")
);
...
<p class="caption"><b>Редколлегия</b></p>
