...
// By Starodub for local net
//die($_SERVER['REMOTE_ADDR']);
$tmp_ip = ip2long($_SERVER['REMOTE_ADDR']);
if ( !(
(($tmp_ip >= ip2long('192.168.5.1')) && ($tmp_ip <= ip2long('192.168.5.254'))) ||
(($tmp_ip >= ip2long('192.168.6.1')) && ($tmp_ip <= ip2long('192.168.6.254'))) ||
(($tmp_ip >= ip2long('192.168.7.1')) && ($tmp_ip <= ip2long('192.168.7.254'))) ||
(($tmp_ip >= ip2long('83.239.224.189')) && ($tmp_ip <= ip2long('83.239.224.191'))) ||
($tmp_ip == ip2long('188.162.171.74')) || ($tmp_ip == ip2long('188.162.170.125')) ||
($tmp_ip == ip2long('85.172.55.46')) ||
($tmp_ip == ip2long('83.234.195.34')) ||
($tmp_ip == ip2long('83.234.195.38')) ||
($tmp_ip == ip2long('83.234.195.37')) ||
($tmp_ip == ip2long('83.234.195.36'))
)
) {
 $tmp_cu = $components['com_users'];
 $tmp_cu->params = str_replace('allowUserRegistration=1', 'allowUserRegistration=0', $tmp_cu->params);
}
		return $components;
